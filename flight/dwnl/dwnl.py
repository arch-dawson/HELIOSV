...
def logdata(packet, sender):
    if sender == "AD":
        with open("/home/pi/HALIOS/flight/adcs.log", 'a') as log:
            log.write(packet)
        print(packet, end="")

    if sender == "UP":
        with open("/home/pi/HALIOS/flight/uplk.log", 'a') as log:
            log.write(packet)
        print(packet, end="")

    if sender == "SE":
        with open("/home/pi/HALIOS/flight/sens.log", 'a') as log:
            log.write(packet)
        print(packet, end="")

    if sender == "DW":
        with open("/home/pi/HALIOS/flight/dwlk.log", 'a') as log:
            log.write(packet)
        print(packet, end="")
...
def main(downlink, gnd):
    ...
    while True:
        ...
        with open("/home/pi/HALIOS/flight/downlink.log", 'a') as log:
            log.write(packet)
